...
export const SCENE_OBJECTS: SceneObject[] = [
	...
	{
		path: "models_optimized/office_chair_cream.glb",
		label: "Chair",
	...
	{
		path: "models_optimized/click_text.glb",
		label: "CODE",
	...
	{
		path: "models_optimized/coffee_mug_school_project.glb",
		label: "Mug",
	...
	{
		path: "models_optimized/rug_round_maple_overlay.glb",

		label: "COASTER",
		position: [P.COASTER_X, P.COASTER_Y, P.COASTER_Z],
		scale: [P.COASTER_SCALE, P.COASTER_SCALE * 0.05, P.COASTER_SCALE],
	...
	{
		path: "models_optimized/ritchie_armchair_barley_beige.glb",
		label: "Armchair",
	...
	{
		path: "models_optimized/coffee_table_final (1).glb",
		label: "coffee table",
...

	{
		...
		scale: [
			...
			P.RUG_MEETING_SCALE * 0.002,
			P.RUG_MEETING_SCALE * 1.25,
		],
	},

	{
		path: "models_optimized/desk_fixed.glb",
		label: "Wall Desk",
	...
	{
		path: "models_optimized/pot-plant-with-mud.glb",
		label: "Stonecrop",
	...
	{
		path: "models_optimized/railing-plant-fixed.glb",
		label: "Stonecrop",
	...
	{
		path: "models_optimized/zelkova_schneideriana_optimized.glb",
		label: "plant",
