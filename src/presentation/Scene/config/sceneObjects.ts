...
export const SCENE_OBJECTS: SceneObject[] = [
  {
    ...
    scale: [P.MOUNTAIN_SCALE, P.MOUNTAIN_SCALE * 0.6, P.MOUNTAIN_SCALE],
    // scale: [P.MOUNTAIN_SCALE, P.MOUNTAIN_SCALE * 1.2, P.MOUNTAIN_SCALE],
  ...
  {
    //path: "models_optimized/desk.glb",
    path: "models/stonecrop_shelf_v2.glb",
    label: "Shelf Desk",
...

  {
    ...
    label: "Shelf Desk",
    position: [P.SHELF_X, P.SHELF_Y, P.SHELF_Z],
    scale: [P.SHELF_SCALE * 0.2, P.SHELF_SCALE * 0.8, P.SHELF_SCALE * 0.2],
  },
