...
export const SCENE_OBJECTS: SceneObject[] = [
  ...
  },
  {
    ...
    scale: [
      P.RUG_OFFICE_SCALE * 1.85,
      P.RUG_OFFICE_SCALE,
      P.RUG_OFFICE_SCALE * 2.5,
    ],
  ...
  },
  {
    ...
    scale: [
      P.COFFEE_TABLE_SCALE * 1.1,
      P.COFFEE_TABLE_SCALE * 0.4,
      P.COFFEE_TABLE_SCALE * 1.3,
    ],
  },
  {
    path: "models_optimized/rug.glb",
    ...
    scale: [
      P.RUG_MEETING_SCALE * 1.8,
      P.RUG_MEETING_SCALE,
      P.RUG_MEETING_SCALE * 1.6,
    ],
  },
  {
