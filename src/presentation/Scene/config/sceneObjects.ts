...
export const SCENE_OBJECTS: SceneObject[] = [
  ...
  },
  {
    ...
    label: "Monitor Left",
    position: [P.MONITOR_LEFT.X, P.MONITOR_LEFT.Y, P.MONITOR_LEFT.Z],
    scale: P.MONITOR_LEFT.SCALE,
    rotationY: P.MONITOR_LEFT.ANGLE,
  },
  {
    path: "models_optimized/monitor.glb",
    label: "Monitor Center",
    position: [P.MONITOR_MIDDLE.X, P.MONITOR_MIDDLE.Y, P.MONITOR_MIDDLE.Z],
    scale: P.MONITOR_MIDDLE.SCALE,
    rotationY: P.MONITOR_MIDDLE.ANGLE,
  },
  {
    path: "models_optimized/monitor.glb",
    label: "Monitor Right",
    position: [P.MONITOR_RIGHT.X, P.MONITOR_RIGHT.Y, P.MONITOR_RIGHT.Z],
    scale: P.MONITOR_RIGHT.SCALE,
    rotationY: P.MONITOR_RIGHT.ANGLE,
  },
  {
...
const TERTIARY_LABELS = new Set<string>([]);
