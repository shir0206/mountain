...
export const PERGOLA_FLOOR_Y = PERGOLA_Y - 5;
export const PERGOLA_FLOOR_Z = PERGOLA_Z;
...
export const FLOWER_Z = SHELF_Z;
export const FLOWER_SCALE = 1;
export const FLOWER_ANGLE = Math.PI / 2;
