 ...
 * 50% of coffee table width, opens browser on click.
 */
export function ClickTextButton3D() {
	...
	// 50% of coffee table width (~1 unit wide, 0.6 deep)
	const width = P.COFFEE_TABLE.SCALE * 0.5;
	const depth = P.COFFEE_TABLE.SCALE * 0.3;
